...
const NewWords: React.FC<NewWordsProps> = ({ words, isDemo, startTest }) => {
  ...
  return (
    <Box sx={{ width: '90%', maxWidth: 400, textAlign: 'center', mx: 'auto', py: '30px', color: 'text.primary' }}>
      <Typography variant="h5" component="h2" sx={{ fontWeight: 600, mb: 0.5 }}>New Words</Typography>
      <Typography variant="subtitle1" component="h4" sx={{ color: 'text.secondary', mb: 2 }}>Click on a character to see information</Typography>
