...
const TestActions: React.FC<TestActionsProps> = ({
  ...
  return (
    <div style={{ paddingTop: '20px', display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: '4px' }}>
      <Button type="secondary" disabled={state.idkDisabled || state.showAnswer} clicked={onIDontKnow} id="idk">
        I Don't Know
      </Button>
      <Button
        type="ghost"
